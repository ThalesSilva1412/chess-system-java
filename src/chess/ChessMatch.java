...
public class ChessMatch {
	...
	private Color currentlPlayer;
	private Board board;
	
	public ChessMatch() {
		board = new Board(8, 8);
		turn = 1;
		currentlPlayer = Color.WHITE;
		initialSetup();
	}
	...
	private void validateSourcePosition(Position source) {
		...
		if(currentlPlayer != ((ChessPiece)board.piece(source)).getColor()) {
	...
	public void nextTurn() {
		turn ++;
		currentlPlayer = (currentlPlayer == Color.WHITE) ? Color.BLACK : Color.WHITE;
	}
